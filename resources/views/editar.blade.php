...
<!-- Formulario de cadastro -->
    <div class="container d-flex justify-content-center bg-light rounded">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('orcamento.update',['orcamento' => $orcamento])}}" method="post" id="update">
                    @csrf
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="cliente">Cliente</span>
                        </div>
                        <input type="text" name="cliente" class="form-control" placeholder="Nome do cliente" aria-describedby="cliente" value="{{$orcamento->cliente}}">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="vendedor">Vendedor</span>
                        </div>
                        <input type="text" name="vendedor" class="form-control" placeholder="Nome do vendedor" aria-describedby="vendedor" value="{{$orcamento->vendedor}}">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="data">Data</span>
                        </div>
                        <input type="date" name="data" class="form-control" placeholder="Data do orçamento" aria-describedby="data" value="{{$orcamento->data}}">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="hora">Hora</span>
                        </div>
                        <input type="time" name="hora" class="form-control" placeholder="Hora do orçamento" aria-describedby="hora" value="{{$orcamento->hora}}">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="valor">Valor</span>
                        </div>
                        <input type="number" step="0.01" name="valor" class="form-control" placeholder="Valor do orçamento" aria-describedby="valor" value="{{$orcamento->valor}}">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="cliente">Descrição</span>
                        </div>
                        <textarea class="form-control" aria-describedby="cliente"  form="update" name="descricao" >{{$orcamento->descricao}}</textarea>
                    </div>
